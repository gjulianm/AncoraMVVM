...
namespace AncoraMVVM.Phone.BindableAppBar
{
    ...
    /// </summary>
    /// <remarks>
    /// To be used in <see cref="BindableAppBar.MenuItems"/> or
    /// <see cref="BindableAppBar.MenuItemTemplate"/>
    /// <para/>
    ...
    /// </code>
    /// </example>
    /// <seealso cref="BindableAppBar"/>
    /// <seealso cref="BindableAppBarButton"/>
    public class BindableAppBarMenuItem : FrameworkElement
    {
        ...
        {
            var target = (BindableAppBarMenuItem)d;
