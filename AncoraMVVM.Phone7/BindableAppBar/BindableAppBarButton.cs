...
namespace AncoraMVVM.Phone7.BindableAppBar
{
    ...
    /// </summary>
    /// <remarks>
    /// To be used in <see cref="BindableAppBar.Buttons"/> or
    /// <see cref="BindableAppBar.ButtonTemplate"/>
    /// The class derives from <see cref="FrameworkElement"/> to support
    /// DataContext and bindings.
    /// </remarks>
    public class BindableAppBarButton : FrameworkElement
    {
        protected ApplicationBar applicationBar;
        protected ApplicationBarIconButton applicationBarIconButton;
        ...
        {
            var target = (BindableAppBarButton)d;
