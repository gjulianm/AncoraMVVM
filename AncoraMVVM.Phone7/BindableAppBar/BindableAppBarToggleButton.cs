...
{
    public class BindableAppBarToggleButton : BindableAppBarButton
    {
        #region Text1
        /// <summary>
        ...
        {
            var target = (BindableAppBarToggleButton)d;
        ...
        #region IconUri1
        /// <summary>
        /// IconUri1 Dependency Property
        /// </summary>
        public static readonly DependencyProperty IconUri1Property =
            DependencyProperty.Register(
                "IconUri1",
                typeof(Uri),
                typeof(BindableAppBarToggleButton),
        ...
        public Uri IconUri1
        {
            get { return (Uri)GetValue(IconUri1Property); }
            set { SetValue(IconUri1Property, value); }
        }

        /// <summary>
        /// Handles changes to the IconUri1 property.
        /// </summary>
        /// <param name="d">
        /// The <see cref="DependencyObject"/> on which
        /// the property has changed value.
        ...
        /// tracks changes to the effective value of this property.
        /// </param>
        private static void OnIconUri1Changed(
            DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var target = (BindableAppBarToggleButton)d;
            Uri oldIconUri = (Uri)e.OldValue;
            Uri newIconUri = target.IconUri1;
            target.OnIconUri1Changed(oldIconUri, newIconUri);
        }
        ...
        /// IconUri property.
        /// </summary>
        /// <param name="oldIconUri">The old IconUri1 value.</param>
        /// <param name="newIconUri">The new IconUri1 value.</param>
        protected virtual void OnIconUri1Changed(
        ...
        #region IconUri2
        /// <summary>
        /// IconUri2 Dependency Property
        /// </summary>
        public static readonly DependencyProperty IconUri2Property =
            DependencyProperty.Register(
                "IconUri2",
                typeof(Uri),
                typeof(BindableAppBarToggleButton),
                new PropertyMetadata(null, OnIconUri2Changed));

        /// <summary>
        /// Gets or sets the IconUri2 property. This dependency property 
        /// indicates the URI to the icon to display for the button.
        /// </summary>
        public Uri IconUri2
        {
            get { return (Uri)GetValue(IconUri2Property); }
            set { SetValue(IconUri2Property, value); }
        }

        /// <summary>
        /// Handles changes to the IconUri2 property.
        /// </summary>
        /// <param name="d">
        /// The <see cref="DependencyObject"/> on which
        /// the property has changed value.
        ...
        /// tracks changes to the effective value of this property.
        /// </param>
        private static void OnIconUri2Changed(
            DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var target = (BindableAppBarToggleButton)d;
            Uri oldIconUri = (Uri)e.OldValue;
            Uri newIconUri = target.IconUri2;
            target.OnIconUri2Changed(oldIconUri, newIconUri);
        }
        ...
        /// IconUri property.
        /// </summary>
        /// <param name="oldIconUri">The old IconUri2 value.</param>
        /// <param name="newIconUri">The new IconUri2 value.</param>
        protected virtual void OnIconUri2Changed(
            Uri oldIconUri, Uri newIconUri)
        {
            if (Toggled)
                IconUri = IconUri2;
